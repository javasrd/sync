...
CREATE USER sync IDENTIFIED BY sync DEFAULT TABLESPACE pivas_tablespace TEMPORARY TABLESPACE pivas_tablespace_temp;
GRANT CREATE SESSION, RESOURCE, CREATE VIEW, UNLIMITED TABLESPACE TO sync;
grant select any table to sync;
grant insert any table to sync;
grant update any table to sync;
exit;
